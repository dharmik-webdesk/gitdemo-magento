...
class Form extends GenericForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title'     => __('Attribute'),
                'required' => true,
                'values'   => Form::getAttibuteCollection()
            ]
        );
    ...
    static public function getAttibuteCollection(){
			...
			$data_array[]=array('value'=>'','label'=>'No Attribute');
			foreach ($attributeSetCollection as $id=>$attributeSet) {
				...
				if ($attributeSet->usesSource() && $attributeSet->getIsFilterable()){
					if($attributeSet->getFrontendLabel()){
						...
						{
							if($option['value'])
								$sub_option[]=array('value'=>$option['value'],'label'=>$option['label']);
						}
						$data_array[]=array('value'=>$sub_option,'label'=>$attributeSet->getFrontendLabel());
					}
				}	
			}
			return($data_array);
