...
class CategoryFilter extends AbstractModel implements CategoryFilterInterface
{
    ...
    const CATEGORY_FILTER_HEADING = 'heading';
    ...
    {
        return $this->getData(self::CATEGORY_FILTER_HEADING);
    }
    /**
     * By MParmar
     * get Attribute Option Id
     *
     * @return string|null $attribute_option_id
     * 
     */
    public function getAttributeOptionId()
    {
        return $this->getData(self::CATEGORY_FILTER_ATTRIBUTE_OPTION_ID);
    }
    /**
     * Set ID
     *
    ...
    {
        $this->setData(self::CATEGORY_FILTER_HEADING, $heading);
    }
     ...
     *
     * @param string|null $attribute_option_id
     * 
     */
    public function setAttributeOptionId($attribute_option_id)
    {
        $this->setData(self::CATEGORY_FILTER_ATTRIBUTE_OPTION_ID, $attribute_option_id);
    }
