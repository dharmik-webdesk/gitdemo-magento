...
class ReplaceCategoryHeadingObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if (!trim($seoForFilterModel->getHeading())) {
            return false;
        }
 
        // MParmar : for Heading customization
        if(!trim($category->getCategoryHeading())):
             $category->setName(trim($seoForFilterModel->getHeading()));
        else:
            $category->setCategoryHeading(trim($seoForFilterModel->getHeading()));
        endif;
    }
}
