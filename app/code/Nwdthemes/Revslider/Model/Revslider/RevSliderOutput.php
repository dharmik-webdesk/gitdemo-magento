...
class RevSliderOutput {
	...
	public function set_placeholders($text){
		...
		$text = $this->_framework->apply_filters( 'revslider_gallery_set_placeholders', $text );
		return $text;
	}
	...
	private function putJS($markup_export = false){
        ...
        <script type="text/javascript">
			...
			require(['themepunchRevolution', 'revslider_showDoubleJqueryError'], function(nwdjQquery, revslider_showDoubleJqueryError) {
...
<?php } ?>
        ...
        if(!$markup_export){ //not needed for html markup export
            if($this->_framework->has_action('wp_footer', array($this, 'add_inline_double_jquery_error')) === false) {
