...
class RevSliderAdmin extends \Nwdthemes\Revslider\Model\Revslider\Framework\RevSliderBaseAdmin {
	...
	private function init(){
		...
		$template = new RevSliderTemplate($this->_framework, $this->_query, $this->_curl, $this->_filesystem, $this->_images, $this->_resource, $this->_googleFonts);
	...
	private static function importSliderOnlineTemplateHandleNew($data, $viewBack = null, $updateAnim = true, $updateStatic = true, $single_slide = false){
		...
		if($uid == ''){
			...
			$tmp = new RevSliderTemplate(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
		...
		try{
			...
			switch($action){
				...
				case "add_slide_to_template":
					$template = new RevSliderTemplate(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
				...
				case 'rs_get_store_information':
					...
					$rattr = array(
						'code' => urlencode($code),
						'product' => Data::REVSLIDER_PRODUCT,
				...
				case 'load_template_store_sliders':
					$tmpl = new RevSliderTemplate(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
				...
				case 'load_template_store_slides':
					...
					$tmp_slider = new RevSliderSlider(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
