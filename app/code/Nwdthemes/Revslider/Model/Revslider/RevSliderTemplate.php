        ...
        if (isset($template["user_template"])) {
            ...
            <div class="template_thumb_more">
                ...
                if ($allow_install !== false) {
                    if($slider_id !== false){
                        ?>
                        <div class="install_template_slider" data-zipname="<?php echo $template['zip']; ?>" data-uid="<?php echo $template['uid']; ?>" data-title="<?php echo $this->_framework->esc_html($template['title']); ?>"><i class="eg-icon-download"></i><?php echo __('Re-Install Slider'); ?></div>
                        <span class="tp-clearfix" style="margin-bottom:5px"></span>
                        <?php
                        if(isset($template['package']) && $template['package'] !== ''){
