...
class Revslider extends \Magento\Framework\View\Element\Template {
    ...
    protected function addHeadIncludes() {
		...
		// km customize for slider issue
		$themecss = $this->getAssetUrl("public/assets/css/settings.css");
		$themejs = $this->getAssetUrl("public/assets/js/themepunch.gs.min.js");
		$content .= '<link  rel="stylesheet" type="text/css"  media="all" href="' . $themecss . '" />';
		$content .= '<script type="text/javascript" src="'.$themejs.'"></script>';
