    ...
    function (_,
        ...
        return _.extend(Validator, {
            ...
            oscBindHandler: function (element) {
                ...
                if (element.component && element.component.indexOf('/group') !== -1) {
                    $.each(element._elems, function (index, elem) {
                    ...
                    element.on('value', function () {
                        ...
                        if (self.isFormInline()) {
                            ...
                            if ($.inArray(element.index, ['region_id', 'region_id_input']) !== -1 || ($.inArray(element.index, observableElements) !== -1 && self.oscValidateAddressData(element.index, addressFlat))) {
