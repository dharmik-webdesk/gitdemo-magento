...
class Setdislike extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (count($collection) > 0) {
            ...
            if ($likedislikeModelLoad->getDislike() == 0) {
                $likedislikeModelLoad->setDislike(1);
