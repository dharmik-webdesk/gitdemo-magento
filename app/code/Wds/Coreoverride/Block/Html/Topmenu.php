...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
  ...
  function getProductList($cat_id){
        ...
        $product_collection = $this->_produdctCollectionFactory->create()
                            ...
                            ->addAttributeToSelect('call_for_price')
...
exit;*/
        ...
        $product_list='<div class="product_list"><h3 class="sub_menu_title">Best Sellers</h3>';
            ...
            $product_list.='<a href="'.$_product_1->getProductUrl().'" title="'.$this->stripTags($_product_1->getName(), null, true).'"><img src="'.$this->_imageHelper->init($_product_1, 'small_image', ['type'=>'small_image'])->keepAspectRatio(true)->resize('100','100')->getUrl().'" width="100" height="100" alt="'.$this->stripTags($_product_1->getName(), null, true).'" /></a>';
