...
class Copier extends \Magento\Catalog\Model\Product\Copier
{
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\Product\CopyConstructorInterface $copyConstructor,
        ...
        do {
            ...
            try {
                ...
                if($dupid){
                    ...
                    $tableName = $connection->getTableName('technicaldata');

                    $product_id = $product->getId();
                    //$sql = "Select * FROM " . $tableName." where product_id =".$product_id;
                    $sql = "Select * FROM " . $tableName." where product_id ='".$product_id."' and attributevalue !=''";
