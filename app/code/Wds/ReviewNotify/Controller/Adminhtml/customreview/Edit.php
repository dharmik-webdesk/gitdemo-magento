...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Wds_ReviewNotify::Customreview')
            ->addBreadcrumb(__('Wds ReviewNotify'), __('Wds ReviewNotify'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('customreview', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Edit Review') : __('New Review'));
