...
class Form extends \Magento\Framework\View\Element\Template
{
    ...
    public function getCurrentUser()
    {
        ...
        if ( $this->_customerSession->getId()) {
            ...
            $defatul_billing=$this->_customerSession->getCustomer()->getDefaultBilling();
            if($defatul_billing){
               $address=$this->_customerAddress->load($defatul_billing);
               $customer_information['address']=$address->getData();
            }    
            $customer_information['customer'] =$this->_customerSession->getCustomerData();
